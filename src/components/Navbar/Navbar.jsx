...
// });
// export const urefbranch=(ubranch);
// console.log(urefbranch);
...
export const Navbar = () => {
  ...
  docRef.get().then((doc) => {
    ...
    // console.log(ubranch);
    setuBranch(doc.data().branch);
    // export const ubranchref=(doc.data().branch);
    // console.log(branch);
  });
  console.log(ubranch);
  ...
  const handleSubmit = (e) => {
    ...
    db.collection("registeredusers")
      .where("subject", "==", tinput.toUpperCase())
      .get()
      .then((querySnapshot) => {
        const emails = [];
        ...
        var templateParams = {
          message: input,
          user_email: "forumrgit@gmail.com",
          cc: emails
        };
      ...
      <div className="qNav">
        ...
        onClick={handleClose1}> */}
            ...
            <MenuItem>
              ...
              {/* <div className="text-menu"> document.write(phoneno)</div> */}
              {/* <div className="text-menu"> Messages</div> */}
            </MenuItem>
            {/* <MenuItem>
            <div>{phoneno}</div>
            ...
            {/* <MenuItem> */}
            {/* if(true){
            db.collection('registeredusers').doc(user.uid).get().then(doc=>{
                <div>$(doc.data().branch</div>
            })
            }
            </MenuItem> */}
            {/* <MenuItem>
                  ...
                  <>
                    ...
                    <div className="modal__Field">
                      ...
                      <Input
                        ...
                        type="text"
                        placeholder="Enter Topic/Subject to wich question belongs"
                      />
                      {/* </> */}
